...
export class CreateViewGrowthNovembro1771506600000 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE OR REPLACE VIEW public.vw_growth_novembro
            ...
            WHERE c.license_type = 'PLANNER'::"biud-esg".companies_license_type_enum
                ...
                AND to_char(c.created_at, 'MM'::text) = '11'::text
                AND ut.id IS NULL;
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP VIEW IF EXISTS public.vw_growth_novembro;`);
    }
}
